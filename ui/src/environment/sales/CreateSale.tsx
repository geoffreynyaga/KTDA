...
function CreateSale() {
  ...
  return (
    <div className="w-full px-2 md:px-6">
      ...
      <div className=" w-full border-2 rounded-lg p-2 md:marker:p-4">
        <form className="w-full  ">
            ...
            <div className="w-full px-3 my-2 md:mb-0">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {lmes !== null &&
                    lmes.map((lme, index) => {
                      return <option key={index}>{lme["name"]}</option>;
                    })}
                </select>
          ...
          {selectedStovesArray !== null &&
            selectedStovesArray.map((stove, index) => {
              return (
                <div
                  key={stove.id}
                  className="w-full flex justify-center items-center flex-row mb-6"
                >
                  <div className="w-1/2 grid grid-cols-3 gap-2 justify-center items-center border-2 bg-green-100 rounded-md shadow-md my-2 py-2 px-4">
                    <div className="grid  my-2  ">
                      Stove:{" "}
                      {stove.id !== undefined ? getStoveName(stove.id) : ""}
                    </div>
                    <div className="grid my-2 ">Kshs. {stove.price}</div>
                    <div className="grid border-2  my-2 ">
                      <button
                        className="py-2 w-full px-4 bg-red-400 rounded-sm"
          ...
          <div className="grid w-full grid-cols-3 gap-2 py-2 md:gap-4 border-2">
            {/* stove */}
                ...
                <>
                  ...
                  <div className="relative">
                    <select
                      className="block w-full px-4 py-3 pr-8 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                      id="grid-state"
                      value={stoveData.id ? stoveData.id : "-----"}
                      onChange={(e) => {
                        if (parseInt(e.target.value) === randomLargeNumber) {
                    ...
                    >
                      ...
                      <option value={randomLargeNumber}>Other</option>
                    </select>
                    <div className="absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 pointer-events-none">
                      <svg
                        className="w-4 h-4 fill-current"
            ...
            <div className="flex flex-col items-start justify-center w-7/12 ">
              ...
              stoveData.name ? (
                <button
                  className="px-4 py-4 w-full text-white  rounded-md text-center"
                  id="add_button"
                  style={{
                    paddingLeft: 4,
                    paddingRight: 4,
                ...
                >
                  <p className="text-xs md:text-md w-full  px-4 text-center self-center">
                ...
                <>
                  ...
                  <p className="px-0 text-red-500">Add a stove and price</p>
                </>
              )}
            </div>
          </div>
          {/*  */}
          <div className="flex flex-wrap justify-center items-center mt-6 mb-2 -mx-3">
