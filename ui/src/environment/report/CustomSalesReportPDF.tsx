                            ...
                            <div className="mt-8 p-9">
                                <div className="border-t pt-9 border-slate-200">
                                    <div className="text-sm font-light text-slate-700">
                                        <p>
                                            This report is generated as is and its only
                                            reflective of the search parameters entered
                                            in the app. It is not a guarantee that the
                                            data is up to date because of delays in LMEs
                                            uploading data.
                                        </p>
                                    </div>
                                </div>
